...
2. ÄLÄ lue .brain/-tiedostoja suoraan — käytä MCP-työkaluja

### Kun työskentelet
1. **Ennen muutoksia**: Kutsu `brain_check_conflicts` tarkistaaksesi ristiriidat
2. **Tiedon hakuun**: Käytä `brain_search` tai `brain_list` — EI grep .brain/
3. **Kun tarvitset yksityiskohtia**: `brain_get_entry` yksittäiselle tietoyksikölle
